package jp.sji.kansai.android.demo.manager.service;

import jp.sji.kansai.android.demo.manager.activity.PushSetUpActivity;
import jp.sji.kansai.android.demo.manager.activity.RequestListActivity;
...
public class C2DMReceiverService extends IntentService {
	...
	private void handleMessage(Context context, Intent intent) {
		...
		CharSequence tickerText = "新しい承認依頼が届きました。";
		...
		// 通知メッセージの作成
		CharSequence contentTitle = "承認依頼";
